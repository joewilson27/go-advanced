...
/*
8. Secure Cookie Store
Penggunaan cookie store KURANG DIANJURKAN, meski sebenarnya cukup aman. Implementasi store jenis ini adalah yang paling mudah,
karena TIDAK BUTUH database server atau media lainnya; dan juga karena API untuk cookie store sudah tersedia dalam gorilla sessions
secara default.
*/
